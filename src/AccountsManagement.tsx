...
export function AccountsManagement({
  ...
  const generateStrongPassword = (): string => {
    ...
    let pwd = "";
    pwd += chars.charAt(Math.floor(Math.random() * 24));
    pwd += chars.charAt(24 + Math.floor(Math.random() * 24));
    pwd += chars.charAt(48 + Math.floor(Math.random() * 8));
    pwd += chars.charAt(56 + Math.floor(Math.random() * 8));
